-- KEY Restaurant & Coffeehouse consolidated production schema

-- Generated from database/schema.sql, survey_schema.sql, homepage_extensions.sql, database/migrations, and migrations/.
