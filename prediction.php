...
<main class="wrap">
    <section class="shell">
        <aside class="panel intro">
            ...
            <p>
                ⚽ هیجان جام جهانی را از نزدیک تجربه کنید! نتیجه مسابقات را پیش‌بینی کنید، میز اختصاصی خود را برای تماشای پخش زنده رزرو کنید و در کنار خانواده و دوستان، لحظاتی فراموش‌نشدنی را در مجموعه رستوران و کافیشاپ کِی رقم بزنید. اگر پیش‌بینی شما درست باشد، شانس برنده شدن جوایز ارزشمند و بن‌های تخفیف ویژه را خواهید داشت.
            </p>

            <p>
                🎁 <strong>جوایز ویژه مسابقه</strong><br>
                🏆 بن تخفیف مجموعه رستوران و کافیشاپ کِی<br>
                🏊 بن تخفیف مجموعه آبی دهکده المپیک<br>
                🏊 بن تخفیف استخر هامون<br>
                🏊 بن تخفیف خانه شنا
                <br><br>
                این جوایز با حمایت مجموعه رستوران و کافیشاپ کِی، مجموعه آبی دهکده المپیک، استخر هامون و خانه شنا به برندگان خوش‌شانس اهدا خواهد شد.
            </p>
