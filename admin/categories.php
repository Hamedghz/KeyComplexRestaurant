...
$config = adminModuleDefinition('categories');
if (!$config) {
...
try {
    ...
    safeAdminLog('Admin module bootstrap failed (categories): ' . $e->getMessage());
}
...
try {
    ...
    safeAdminLog('Admin module rows failed (categories): ' . $e->getMessage());
}
