...
try {
    ...
    safeAdminLog('Admin module bootstrap failed (surveys): ' . $e->getMessage());
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error) {
    try {
        ...
        safeAdminLog('Admin module save failed (surveys): ' . $e->getMessage());
...
try {
    ...
    safeAdminLog('Admin module rows failed (surveys): ' . $e->getMessage());
}
