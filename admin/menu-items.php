...
$config = adminModuleDefinition('menu-items');
if (!$config) {
...
try {
    ...
    safeAdminLog('Admin module bootstrap failed (menu-items): ' . $e->getMessage());
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error) {
    try {
        ...
        safeAdminLog('Admin module save failed (menu-items): ' . $e->getMessage());
...
try {
    ...
    safeAdminLog('Admin module rows failed (menu-items): ' . $e->getMessage());
}
